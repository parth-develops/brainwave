...
function Section({ className, id, crosses, crossesOffset, customPaddings, children }) {
    return (
        <section id={id} className={`relative ${customPaddings || `py-10 lg:py-16 xl:py-20 ${crosses ? "lg:py-20 xl:py-26" : ""}`} ${className || ''}`}>
            {children}
            ...
            {crosses && <>
                <div className={`hidden absolute top-0 left-7.5 right-7.5 h-0.25 bg-stroke-1 ${crossesOffset || ''} pointer-events-none lg:block xl:left-10 right-10`} />
